...
#define API_TOKEN @"d4a870191b3c140bb1121a64f685f354"
...
- (void)cityForCurrentIP:(void (^)(City *))completion {
    [self IPAddressWithCompletion:^(NSString *ipAdress) {
...
- (void)IPAddressWithCompletion: (void (^)(NSString *ipAdress)) completion {
